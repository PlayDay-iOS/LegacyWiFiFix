...
Fixes WiFi connectivity to WPA2/WPA3 transitional networks on iOS 10.x.

Modern routers using WPA2/WPA3 transitional mode advertise both PSK (AKM 2)
and SAE (AKM 8) in their RSN Information Element. iOS 10's `wifid` doesn't
...
leaving only AKMs that iOS 10 understands (1-6).
